...
bool InspectorWindow::Init(RendererEngine &renderer)
{
    ...
    m_EditorMap["MeshResource"]         = std::make_unique<MeshResourceEditor>();
    ...
    m_EditorMap["ModelMeshRenderer"]    = std::make_unique<ModelMeshRendererEditor>();
